...
class mobil_model extends CI_Model
{
    ...
    {
        $this->db->select('mobil.id_mobil, mobil.id_type, mobil.merk, mobil.no_plat, mobil.warna, mobil.tahun, mobil.harga, mobil.status, mobil.gambar, type.id_type, type.kode_type, type.nama_type');
        $this->db->from('mobil');
