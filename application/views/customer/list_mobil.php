                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb">
                                        <img src="<?= base_url() . 'assets/upload/mobil/' . $mb->gambar ?>" style="height: 320px; width: 540px">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="<?= base_url('customer/rental/detail_mobil/') . $mb->id_mobil ?>"><?= $mb->merk ?></a></h2>
                                        <h5 style="color: #ae8b0c"><?= format_rupiah($mb->harga) ?> / hari</h5>
                                        <?php if ($mb->status == 1) { ?>
                                            <a href="<?= base_url('customer/rental/tambah_rental/') . $mb->id_mobil ?>" class="btn btn-lg btn-dark text-white" style="cursor: pointer">Rental</a>
                                            <a href="<?= base_url('customer/dashboard/detail_mobil/') . $mb->id_mobil ?>" class="btn btn-lg btn-dark text-white" style="cursor: pointer">Detail</a>
                                        <?php } else { ?>
                                ...
                                <div class="single-car-wrap">
                                    ...
                                    <div class="car-list-info without-bar">
                                        ...
                                        <ul class="car-info-list">
                                            ...
                                            <li><i class="fa fa-times-circle text-danger"></i> Diesel</li>
                                            <li><i class="fa fa-check-square" style="color: #014782"></i> Auto</li>
                                            <li><i class="fa fa-times-circle text-danger"></i> Diesel</li>
                                        </ul>
                                        <p class="rating">
